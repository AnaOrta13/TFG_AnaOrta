        ...
        <div className='mb-10'>
            <div className="sm:hidden">
                ...
                <select
                    id="tabs"
                    name="tabs"
                    className="block w-full rounded-md border-gray-300 focus:border-indigo-400 focus:ring-indigo-400"
                            ...
                            <Link
                                ...
                                className={classNames(
                                    location.pathname === tab.href
                                        ...
                                        : 'border-transparent text-gray-500 hover:border-gray-300 hover:text-indigo-400',
                                    'group inline-flex items-center border-b-2 py-4 px-1 text-sm font-medium'
                                )}
                            >
                                <tab.icon
                                    className={classNames(
                                        location.pathname === tab.href ? 'text-indigo-400' : 'text-gray-400 group-hover:text-indigo-400',
                                        '-ml-0.5 mr-2 h-5 w-5'
                                    )}
                                    aria-hidden="true"
                                />
