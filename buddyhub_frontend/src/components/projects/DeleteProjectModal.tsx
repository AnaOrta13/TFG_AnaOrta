                        ...
                        >
                            <Dialog.Panel className="w-full max-w-4xl transform overflow-hidden rounded-2xl bg-white text-left align-middle shadow-xl transition-all p-16">
                                ...
                                <p className="text-xl font-bold text-center">Confirma la eliminación del proyecto {''}
                                    <span className="text-indigo-500">colocando tu contraseña</span>
                                </p>
                                ...
                                >
                                    ...
                                    <input
                                        type="submit"
                                        className=" bg-rose-700 hover:bg-rose-900 w-full p-3  text-white font-black  text-xl cursor-pointer"
