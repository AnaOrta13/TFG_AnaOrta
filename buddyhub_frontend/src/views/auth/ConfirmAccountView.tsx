...
export default function ConfirmAccountView() {
    ...
    return (
        <>
            <h1 className="text-5xl font-black text-white text-center">Confirma tu Cuenta</h1>
            <p className="text-2xl font-light text-white mt-5 text-center">
                Ingresa el código que recibiste {''}
                <span className=" text-indigo-400 font-bold"> por email</span>
            </p>
            <form
            ...
            <nav className="mt-10 flex flex-col space-y-4">
                <Link
                    ...
                    className="text-center text-slate-300 font-normal "
                >
