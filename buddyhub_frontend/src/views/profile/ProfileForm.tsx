    ...
    return (
        <>
            <div className="mx-auto max-w-3xl g">
                <h1 className="text-5xl font-black text-center">Mi Perfil</h1>
                <p className="text-2xl font-light text-gray-500 mt-2 text-center">Aquí puedes actualizar tu información</p>
