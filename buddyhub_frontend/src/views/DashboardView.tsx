...
export default function DashboardView() {
  ...
  if (data && user) return (
    <>
      <h1 className="text-5xl font-black text-center"> PROYECTOS</h1>
      <p className="text-2xl font-light text-gray-500 mt-2 text-center">Gestiona tus proyectos</p>

      <nav className="my-5 mt-6">
        <Link
                ...
                <div className="min-w-0 flex-auto space-y-2">
                  <div className="mb-2">
                    {isManager(project.manager, user._id) ?
                      ...
                      border-indigo-500 rounded-lg inline-block py-1 px-5">Administrador</p> :
